...
export RUSTFLAGS='-C linker=aarch64-elf-gcc -C target-cpu=cortex-a53 -C target-feature=+a53,+fp-armv8,+neon -C link-arg=-nostartfiles -C link-arg=-T./link.ld -C opt-level=3 -C debuginfo=0'
